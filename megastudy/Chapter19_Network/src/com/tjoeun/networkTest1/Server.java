...
public class Server {
    ...
    public static void main(String[] args) {
        ...
        Scanner scanner; // 클라이언트에서 전송되는 데이터를 읽는 Scanner
        PrintWriter printWriter; // 클라이언트로 데이터를 전송하는 PrintWriter

        try {
//			서버를 만든다.
//			192.168.0.26의 ip 주소를 가지는 서버의 10004번 포트를 열어 서버 소켓을 생성한다.
