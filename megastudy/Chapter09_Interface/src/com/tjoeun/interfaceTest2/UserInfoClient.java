...
//		FileInputStream 클래스는 파일에서 바이트 단위로 데이터를 읽어온다.
        ...
        try {
            String filepath = "./Chapter09_Interface/src/com/tjoeun/interfaceTest2/db.properties";
...
//			read() 메소드는 읽어들인 데이터가 있으면 읽어들인 데이털 코드값으로 리턴하고 읽어들인
...
//			getProperty() 메소드는 인수로 지정된 properties 파일의 key("=" 왼쪽부분)에 해당되는
//			value("=" 오른쪽부분)를 얻어온다.
