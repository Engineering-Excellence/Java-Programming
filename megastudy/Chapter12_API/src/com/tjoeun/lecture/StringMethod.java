...
//		데이터 입력 단계에서 불필요한 공백을 제거하고 입력받으려면 아래와 같이 trim()
//		메소드를 사용한다.
...
//		System.out.println(ch);
        ...
        str = "TjoeunIT";
//		toUpperCase() 메소드는 영문자를 무조건 대문자로 변환하고 toLowerCase() 메소드는
//		영문자를 무조건 소문자로 변환한다.
...
//		substring(a, b): 문자열 a번째 index의 문자부터 b - 1 번째 index의 문자까지 얻어온다.
...
//		lastIndexOf() 메소드는 문자열의 오른쪽부터 검색해서 인수로 지정한 문자열이 최초로 나타나는
//		index를 얻어온다.
        System.out.println(str.indexOf("it"));
        System.out.println(str.lastIndexOf("it"));
//		indexOf(), lastIndexOf() 메소드는 인수로 지정한 문자열이 없으면 -1일 리턴한다.
        System.out.println(str.indexOf("It"));
        System.out.println(str.lastIndexOf("IT"));
