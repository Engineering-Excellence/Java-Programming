package com.tjoeun.abstract_class;
...
//		PolymorphismTest 클래스에서는 이런식으로 실행...
...
//		private void moveAnimal2(Animal animal) { }
        ...
        for (Animal animal : animalList) {
            ...
            */
            switch (animal) {
                case Human human -> human.readBooks();
                case Tiger tiger -> tiger.hunting();
                case Eagle eagle -> eagle.flying();
                case null, default -> System.out.println("downcasting 불가능");
            }
        }
