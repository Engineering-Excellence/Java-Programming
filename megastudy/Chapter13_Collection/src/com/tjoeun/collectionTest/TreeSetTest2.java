...
//		향상된 for 사용해서 TreeSet이나 TreeSet 객체의 데이터를 1개씩 얻어올 수 있다.
        for (String str : tset) {
...
//		Iterator 인터페이스 TreeSet이나 TreeSet 같이 입력하는 순서와 저장되는 순서가 달라서
...
//			System.out.println(iterator.next());
            list.add("Iterator 인터페이스 객체 사용 => " + iterator.next());
        }
