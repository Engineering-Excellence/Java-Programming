...
//		일반 고객 객체 생성
        ...
        System.out.println("회원 정보: " + customerLee.showCuntomerInfo());
        ...
        System.out.println("회원 정보: " + customerLim.showCuntomerInfo());
        System.out.println("실 구매 금액: " + customerLim.calcSales(10000));
