...
//		같은(비슷한) 기능을 실행하는 메소드의 인수가 서로다를 경우 많은 수의 메소드 오버로딩이 필요하다.
        System.out.println("sum(1, 2) = " + sum(1, 2));
        System.out.println("sum(1, 2, 3) = " + sum(1, 2, 3));
        System.out.println("sum(1, 2, 3, 4) = " + sum(1, 2, 3, 4));
        System.out.println("sum(1, 2, 3, 4, 5) = " + sum(1, 2, 3, 4, 5));

//		메소드의 인수를 배열로 구현하면 많은 수의 오버로딩이 필요 없지만 인수를 배열로 선언하고
...
//	메소드 이름이 같으면 인수의 개수로 메소드를 식별하고 만약에 인수의 개수도 같다면 인수의
//	데이터 타입으로 메소드를 식별한다.
