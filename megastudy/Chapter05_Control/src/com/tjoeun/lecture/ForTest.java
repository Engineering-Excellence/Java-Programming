...
//		조건을 만족하면 {} 블록의 내용을 실행하고 i를 증감치 만큼 변경한 후 조건을 만족하면
//		{} 블록을 실행하고 조건을 만족하지 않으면 반복을 종료한다.
        for (int i = 1; i <= 10; i++) {
//			대입 연산자: "="와 같이 사용한다. +=, -=, *=, /=, %=, ...
...
//		a++: 사용 후 1증가, a 변수에 저장된 값을 사용(연산)하고 ";"을 만나서 문장이 종료될 때 1증가한다.
//		++a: 1증가 후 사용, a에 저장된 값을 1증가시키고 사용한다.
//		a--: 사용 후 1감소, a 변수에 저장된 값을 사용(연산)하고 ";"을 만나서 문장이 종료될 때 1감소한다.
