...
public class PrintThread extends Thread {
    ...
    public void run() {
		/*
//		CalculatorThread의 실행이 끝날때(shareArea.ready에 true가 저장될 때)까지 대기시킨다.
		System.out.println("헉... 헉... 열심히 계산중..");
...
//		wait() 메소드로 CalculatorThread의 스레드 실행이 끝날때까지 대기한다.
//		wait() 메소드는 현재 스레드를 다른 스레드에서 깨울때까지 멈춘다.
...
//		동기화 블록
//		동기화 블록의 인수는 여러 스레드가 같이 사용하는 공유 영역으로 사용되는 객체 이름을
//		쓰면된다.
