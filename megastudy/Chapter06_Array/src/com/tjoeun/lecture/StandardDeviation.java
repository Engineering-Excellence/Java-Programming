...
public class StandardDeviation {
    ...
    public static void main(String[] args) {
		...
		/*
//		최대값을 기억할 기억장소는 아주 작은 값을, 최소값을 기억할 기억장소는 아주 큰 값을
//		초기치로 지정한다.
		int max = 0;
		int min = 100;
		...
		*/
		...
		/*
//		최대값과 최소값을 기억할 기억장소에 각각 데이터가 저장된 배열의 0번째 인덱스 요소를
//		초기치로 지정한다.
		int max = data[0];
		int min = data[0];
		
//		i가 1부터 시작하는 이유는 최대값과 최소값을 기억할 변수에 배열의 0번째 인덱스의 값을
//		초기치로 지정했고 자기 자신끼리 비교해봐야 최대값 최소값을 판별하는데 전혀 도움이
//		되지 않기 때문이다.
