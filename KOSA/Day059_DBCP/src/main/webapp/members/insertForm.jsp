...
<head>
    ...
    <script language="JavaScript">
        function checkIt() { //사용자가 입력폼에 입력한 상황을 체크
            ...
            if (userinput.passwd.value != userinput.passwd2.value) {  //비밀번호와 재입력비밀번호가 같지 않으면 수행
            ...
            if (!userinput.jumin1.value || !userinput.jumin2.value) { //주민번호의 앞자리와 뒷자리를 입력하지 않으면 수행
                alert("주민등록번호 넣으세요");
                return false;
            }
        }
