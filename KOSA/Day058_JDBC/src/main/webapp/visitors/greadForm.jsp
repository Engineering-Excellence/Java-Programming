...
//		Vector<BookVO> data = BookDAO.select(conn, mypage, numPerPage);
        List<BookVO> data = BookDAO.selectAll(mypage, numPerPage);

        int n = data.size();  // 5
        out.print("<table width ='100%' >");
        for (int i = 0; i < n; i++) {
//			BookVO vo = (BookVO) data.elementAt(i);
            BookVO vo = data.get(i);
            int num = vo.getNum();          /////////////////////////
    ...
    <tr>
        <td>내 용 : <p style='text-align: justify'><%= contents %>
        </p></td>
    </tr>
    <% } // for end  %>
    </table>
    <div style="text-align: center;">
        <%
            ...
            double totalPage = BookDAO.getPageCount(numPerPage);  // 4
            //총 블록수 계산
        ...
        <a href="greadForm.jsp?page=<%=pn %>"><%=pn %>
        </a>&nbsp;&nbsp;&nbsp;
