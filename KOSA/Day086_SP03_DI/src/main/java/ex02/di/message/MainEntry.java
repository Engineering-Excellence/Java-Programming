...
public class MainEntry {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("app == app2 : " + (app == app2));   // Spring은 기본적으로 Singleton
        System.out.println(app.hashCode() + " / " + app2.hashCode());

        MyApplication facebook = ctx.getBean("myApplication2", MyApplication.class);
        facebook.processMessage("Facebook", "https://www.facebook.com/doyeon.lee.58760");
