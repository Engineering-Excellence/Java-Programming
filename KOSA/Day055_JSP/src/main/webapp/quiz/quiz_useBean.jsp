...
<body>
<jsp:useBean id="gift" class="kr.or.sw.quiz.GiftVO">
...
<marquee scrollamount="30">
    ...
    <table border="1" cellpadding="5" cellspacing="20">
        <tr>
            <th>상품번호</th>
            <td>
                <jsp:getProperty name="gift" property="GNo"/>
            </td>
        </tr>
        <tr>
            <th>상품명</th>
            <td>
                <jsp:getProperty name="gift" property="GName"/>
            </td>
        </tr>
        <tr>
            <th>최저가</th>
            <td>
                <jsp:getProperty name="gift" property="GStart"/>
            </td>
        </tr>
        <tr>
            <th>최고가</th>
            <td>
                <jsp:getProperty name="gift" property="GEnd"/>
            </td>
        </tr>
    </table>
</marquee>
