...
<body>
<h1> 답변 </h1>
<a href="/list?page=${page}">리스트</a>
<form name="writeform" action="/reply" method="post">
    <table width="600">
        <tr>
            <th>이름</th>
            <td>
                ...
                <input type="hidden" name="parent" value="${boardDTO.parent}"/>
                <input type="hidden" name="sort" value="${boardDTO.sort}"/>
                <input type="hidden" name="tab" value="${boardDTO.tab}"/>
        ...
        <tr>
            <th>제목</th>
            <td>
                <input type="text" name="subject" maxlength="50" size="65" value="RE:${boardDTO.subject}"/>
            </td>
        </tr>
        <tr>
            <th>내용</th>
